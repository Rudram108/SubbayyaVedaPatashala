		...
		*/
		function playLaghunyasam(buttonNum)
			{
				//alert(anuNum);
				//alert(buttonNum);
		...
		if(getLearningMode() == 'com'){
			var sourceAud = "audio/Laghunyasam/"+"com.mp3";
			document.getElementById("anu1").style.pointerEvents = "not-allowed";}
		else if(buttonEle instanceof HTMLSpanElement)
			sourceAud = "audio/Laghunyasam/" + "ww_" + buttonNum +".mp3";
		else
			sourceAud = "audio/Laghunyasam/" +getLearningMode()+"_" + buttonNum +".mp3";
		//alert('here');
		...
		*/
		...
		if(mode == 'com'){
			try{
			source.src = "audio/Laghunyasam/PPcom.mp3";
			if(!sounds.paused)
				{
					sounds.pause();								
				}
		...
		*/			
			function setTextMode(tMode){
				...
				var scr = "Laghunyasam" + getLanguage() + tMode+".html";
			//alert(scr);
				var iframe = document.getElementById("anu");
			//alert("iframe");
		...
		*/			
			...
			/*changes made*/
			var iframe = document.getElementById("anu");
			var scr = "Laghunyasam" + lang + getTextMode()+".html";
