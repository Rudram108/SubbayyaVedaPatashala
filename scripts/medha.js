		...
		*/
		...
		{
			var sourceAud = "audio/MedhaSuktam/PPcom.mp3";
			...
			sourceAud = "audio/MedhaSuktam/" + "ww_" + buttonNum +".mp3";
		else
			sourceAud = "audio/MedhaSuktam/" +getLearningMode()+"_" + buttonNum +".mp3";
		//alert('here');
		...
		*/
		...
		sounds.onended = function() {
			...
			if(getLearningMode() == 'com'){playMedha('00');	}
		...
		*/
		...
		if(mode == 'com'){
			try{
			source.src = "audio/MedhaSuktam/PPcom.mp3";
			if(!sounds.paused)
				{
					sounds.pause();								
				}
		...
		*/			
			function setTextMode(tMode){
				...
				var scr = "medha" + getLanguage() + tMode+".html";
			//alert(scr);
				var iframe = document.getElementById("anu");
			//alert("iframe");
		...
		*/			
			...
			/*changes made*/
			var iframe = document.getElementById("anu");
			var scr = "medha" + lang + getTextMode()+".html";
