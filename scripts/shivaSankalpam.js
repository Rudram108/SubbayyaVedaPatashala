		...
		*/
		function playShivaSankalpam(buttonNum)
			{
				//alert(anuNum);
				//alert(buttonNum);
		...
		if(getLearningMode() == 'com'){
			var sourceAud = "audio/ShivaSankalpam/"+"com.mp3";
			document.getElementById("anu1").style.pointerEvents = "not-allowed";}
		else if(buttonEle instanceof HTMLSpanElement)
			sourceAud = "audio/ShivaSankalpam/" + "ww_" + buttonNum +".mp3";
		else
			sourceAud = "audio/ShivaSankalpam/" +getLearningMode()+"_" + buttonNum +".mp3";
		//alert('here');
		...
		*/
		...
		if(mode == 'com'){
			try{
			source.src = "audio/ShivaSankalpam/PPcom.mp3";
			if(!sounds.paused)
				{
					sounds.pause();								
				}
