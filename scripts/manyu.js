		...
		*/
		function playManyuSuktam(buttonNum)
			{
				//alert(anuNum);
				//alert(buttonNum);
		...
		{
			var sourceAud = "audio/ManyuSuktam/PPcom.mp3";
			...
			sourceAud = "audio/ManyuSuktam/" + "ww_" + buttonNum +".mp3";
		else
			sourceAud = "audio/ManyuSuktam/" +getLearningMode()+"_" + buttonNum +".mp3";
		//alert('here');
		...
		*/
		...
		sounds.onended = function() {
			...
			if(getLearningMode() == 'com'){playManyuSuktam('00');	}
		...
		*/
		...
		if(mode == 'com'){
			try{
			source.src = "audio/ManyuSuktam/PPcom.mp3";
			if(!sounds.paused)
				{
					sounds.pause();								
				}
		...
		*/			
			function setTextMode(tMode){
				...
				var scr = "suktamManyu" + getLanguage() + tMode+".html";
			//alert(scr);
				var iframe = document.getElementById("anu");
			//alert("iframe");
		...
		*/			
			...
			/*changes made*/
			var iframe = document.getElementById("anu");
			var scr = "suktamManyu" + lang + getTextMode()+".html";
